...
% Last Modified by GUIDE v2.5 29-Nov-2021 16:05:07
...
if ~isequal(nama_file,0)
    ...
    %simpan variabel img pada lokasi handles
    handles.img = img;
    guidata(hObject, handles)
else
...
%tampilkan citra RGB hasil segmentasi pada axes2
axes(handles.axes2)
imshow(RGB)
title('Citra RGB - Segmentasi')

%simpan variabel RGB dan bw pada lokasi handles
handles.R = R;
handles.G = G;
handles.B = B;
handles.bw = bw;
handles.circularity = circularity;
handles.eccentricity = eccentricity;
guidata(hObject, handles)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%panggil variabel RGB dan bw handles
R = handles.R;
G = handles.G;
B = handles.B;
bw= handles.bw;
circularity = handles.circularity;
...
set(handles.edit4, 'String', num2str(Red));
set(handles.edit5, 'String', num2str(Green));
set(handles.edit6, 'String', num2str(Blue));
set(handles.edit9, 'String', num2str(circularity));
set(handles.edit10, 'String', num2str(eccentricity));

%simpan variabel ciri uji handles
...
% panggil variabel ciri_uji handles
...
%tampilkan kelas prediksi pada edit text
